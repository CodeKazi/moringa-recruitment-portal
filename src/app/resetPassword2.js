...
const ResetPassword = () => {
  return (
    <div className='relative w-full h-full lg:h-[1024px] bg-white flex flex-col items-center'>
        <div className='absolute box-border flex flex-col items-start lg:px-[100px] pt-5 lg:pt-3 lg:pb-[100px] gap-10 w-full lg:h-[80px] lg:left-0 lg:top-0 border-b-1 border-b-solid border-b-black border-b-opacity-25'>

export const alumProfile = {
    headline: {
        name: 'Ismaili Sarr',
        title: 'Front-end Software Developer | React | JavaScript | ',
        location: 'Nairobi',
        imageSrc:'/assets/sarr.png'
    },
    about: {
